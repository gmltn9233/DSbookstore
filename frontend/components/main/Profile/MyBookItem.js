    ...
    render(){
        return(
            <View style={{flexDirection:'row',borderBottomWidth:0.7, borderColor:'lightgray',backgroundColor:this.state.backgroundColor,opacity:this.state.opacity} }>
                <View>
                    <BookDetail visible={this.state.modalVisible} closeModal = {this.closeModal.bind(this)} bookName={this.props.name} className={this.props.className} price={this.props.price}
