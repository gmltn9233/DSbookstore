...
export default class BookTab extends React.Component{
    ...
    getSMS = async() => {
        try{
          ...
          SMS.sendSMSAsync(this.props.phone, '안녕하세요! 판매중이신 "' + this.props.bookName + '" 책을 구입하고 싶어요!!'); //고정된 메세지를 보낼 수 있게 한다
        }catch(error){
        ...
        <Modal visible={this.props.visible} animationType='fade' onRequestClose={this.props.closeModal}>
            ...
            <View style={styles.Container}>
                ...
                <View style={styles.UpperContainer}>
                    ...
                    <View style={{justifyContent:'center', marginLeft: 10, flex:0.9}}>
                    ...
                    <View style={styles.heart}>
                        {this.props.currentUserLike ? (
                                    <Ionicons name = 'heart' color = {"#F15F5F"} size = {30} />
                                        ...
                                        this.props.currentUserLike === false ? 
                                        <TouchableOpacity>
